...
export default class IframeSettings extends Component {
    constructor(props) {
        super();
        this.state = {
        ...
        this.messages = Language.getDataByKey("novi-plugin-iframe");
    }
    ...
    render() {
        return (
            <div>
                <span style={{letterSpacing: "0,0462em"}}>Iframe Plugin</span>
